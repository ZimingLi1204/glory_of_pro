...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MoveWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MoveWidget_t qt_meta_stringdata_MoveWidget = {
    {
QT_MOC_LITERAL(0, 10) // "MoveWidget"
...
const QMetaObject MoveWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_MoveWidget.offsetsAndSize,
    qt_meta_data_MoveWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MoveWidget_t
, QtPrivate::TypeAndForceComplete<MoveWidget, std::true_type>
