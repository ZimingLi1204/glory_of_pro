...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MousePos_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MousePos_t qt_meta_stringdata_MousePos = {
    {
QT_MOC_LITERAL(0, 8) // "MousePos"
...
const QMetaObject MousePos::staticMetaObject = { {
    ...
    qt_meta_stringdata_MousePos.offsetsAndSize,
    qt_meta_data_MousePos,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MousePos_t
, QtPrivate::TypeAndForceComplete<MousePos, std::true_type>
