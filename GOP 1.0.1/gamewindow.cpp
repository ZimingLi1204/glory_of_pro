...
//                break;
    ...
    switch(bd.player_num) {
        case 2: player_image[2] -> hide();
            player_image[3] -> hide();
            player_image[0] -> move(coordinate[bd.pl[0].pos[1]-1], coordinate[bd.pl[0].pos[0]-1]);
            player_image[1] -> move(coordinate[bd.pl[1].pos[1]-1], coordinate[bd.pl[1].pos[0]-1]);
            player_move_image[0] -> move(coordinate[bd.pl[0].pos[1]-1], coordinate[bd.pl[0].pos[0]-1]);
            player_move_image[1] -> move(coordinate[bd.pl[1].pos[1]-1], coordinate[bd.pl[1].pos[0]-1]);
            player_image[0] -> show();
            player_image[1] -> show();
            break;
        case 3: player_image[3] -> hide();
            ...
            if (bd.pl[2].isAlive) {
                player_image[2] -> move(coordinate[bd.pl[2].pos[1]-1], coordinate[bd.pl[2].pos[0]-1]);
                player_move_image[2] -> move(coordinate[bd.pl[2].pos[1]-1], coordinate[bd.pl[2].pos[0]-1]);
                player_image[2] -> show();
            }
            break;
        default:
            ...
            if (bd.pl[3].isAlive) {
                player_image[3] -> move(coordinate[bd.pl[3].pos[1]-1], coordinate[bd.pl[3].pos[0]-1]);
                player_move_image[3] -> move(coordinate[bd.pl[3].pos[1]-1], coordinate[bd.pl[3].pos[0]-1]);
                player_image[3] -> show();
            }
            break;
    }
